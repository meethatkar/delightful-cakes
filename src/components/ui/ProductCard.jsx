const ProductCard = ({ 
  ...
  return (
    <div className={`flex flex-col items-center group cursor-pointer ${className}`} {...props}>
      {/* Image Container with subtle background */}
      <div className="w-full aspect-square bg-stone-50 flex items-center justify-center p-8 mb-6 transition-colors duration-300 group-hover:bg-stone-100">
        <img 
          src={image} 
          alt={alt || title} 
